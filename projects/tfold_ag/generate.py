...
def parse_args():
    parser = argparse.ArgumentParser(description='Antibody & antigen structures design w/ tFold-Ag')
...
def generate(args):
    """generate antibody & antigen sequence and structures w/ pre-trained tFold-Ag models, only for antibody design"""
